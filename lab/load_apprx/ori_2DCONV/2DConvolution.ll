; ModuleID = '2DConvolution.cl'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind uwtable
define void @Convolution2D_kernel(float* nocapture readonly %A, float* nocapture %B, i32 %ni, i32 %nj) #0 {
...
; <label>:5                                       ; preds = %0
  ...
  br i1 %or.cond3, label %10, label %64
...
; <label>:10                                      ; preds = %5
  ...
  %52 = tail call float @llvm.fmuladd.f32(float 0x3FD99999A0000000, float %51, float %45)
  %53 = add nsw i32 %47, %1
  %54 = sext i32 %53 to i64
  %55 = getelementptr inbounds float, float* %A, i64 %54
  %56 = load float, float* %55, align 4, !tbaa !7
  %57 = tail call float @llvm.fmuladd.f32(float 0x3FE6666660000000, float %56, float %52)
  %58 = add nsw i32 %47, %24
  %59 = sext i32 %58 to i64
  %60 = getelementptr inbounds float, float* %A, i64 %59
  %61 = load float, float* %60, align 4, !tbaa !7
  %62 = tail call float @llvm.fmuladd.f32(float 0x3FB99999A0000000, float %61, float %57)
  %63 = getelementptr inbounds float, float* %B, i64 %37
  store float %62, float* %63, align 4, !tbaa !7
  br label %64

; <label>:64                                      ; preds = %10, %5, %0
  ret void
}
...
!0 = !{void (float*, float*, i32, i32)* @Convolution2D_kernel, !1, !2, !3, !4, !5}
